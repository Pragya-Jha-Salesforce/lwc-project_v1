...
export default class projectLWC extends LightningElement {
	...
	createLead(){
		...
		console.log('FirstName: ' + this.strFirstName);
		console.log('LastName: ' + this.strLastName);
		console.log('Company: ' + this.strCompany);
		console.log('OptionValue: ' + this.stroptionValue);
		console.log('AnnualRevenue: ' + this.strAnnualRevenue);
		console.log('Email: ' + this.strEmail);
		console.log('Phone: ' + this.strPhone);
		console.log('IndustryValue: ' + this.strIndustryValue);
		
		var leadObject = {
			'FirstName' : this.strFirstName,
			'LastName' : this.strLastName,
			'Company' : this.strCompany, 
			'Status' : this.stroptionValue,
			'AnnualRevenue' : this.strAnnualRevenue,
			'Email' : this.strEmail, 
			'Phone' : this.strPhone,
			'Industry' : this.strIndustryValue
		};
		
		// Record details to pass to create method with api name of Object.
		var objRecordInput = {'apiName' : 'Lead', leadObject};
